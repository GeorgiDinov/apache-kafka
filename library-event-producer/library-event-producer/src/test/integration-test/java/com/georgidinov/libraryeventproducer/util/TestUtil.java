package com.georgidinov.libraryeventproducer.util;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.georgidinov.libraryeventproducer.domain.Book;
...
public class TestUtil {
    ...
    public static Book bookRecord() {
        ...
        return new Book(123, "Kafka Using Spring Boot", "Test Author");
    }
